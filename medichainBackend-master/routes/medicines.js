...
router.get('/getAll', (req, res) => {
    try {
        const medicines = Medicines.find().populate("production", "-password -token");
        medicines.then((allMedicines) => {
...
router.get('/getMedicineById/:id', (req, res) => {
    ...
    const medicines = Medicines.findOne({ id }).populate("production", "-password -token");
